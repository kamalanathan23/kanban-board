/**
 * Central permission keys — use these in middleware, seeds, and API responses.
 * Grouped by area for admin UI (see PERMISSION_GROUPS).
 */
...
/** Wildcard: role has every permission */
